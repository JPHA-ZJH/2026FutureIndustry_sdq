...
- Adds a separate quantum metrology / time-frequency / PNT candidate pool.
...
QUANTUM_RULES: List[Dict] = [
    ...
    {"category": "量子传感", "sub_category": "时间频率/PNT", "terms_cn": ["氢原子钟", "铷原子钟", "铯原子钟", "冷原子钟", "光钟", "原子钟", "原子钟频率", "原子钟联合守时", "光学频率传递", "时间频率传递", "频率驾驭", "原子时", "时间尺度"], "terms_en": ["hydrogen maser", "rubidium atomic clock", "cesium atomic clock", "caesium atomic clock", "cold atom clock", "optical atomic clock", "optical clock", "atomic clock", "optical frequency transfer", "time-frequency transfer", "time frequency transfer", "atomic time"], "score": 3, "match_type": "time_frequency", "source_type": "专家补充词", "note": "广义量子传感/量子计量/PNT候选；默认不进入核心量子企业池"},
...
TIMEFREQ_CONTEXT_TERMS_CN = [
    "氢原子钟", "铷原子钟", "铯原子钟", "冷原子钟", "光钟", "原子钟", "原子钟频率", "原子钟联合守时",
    "光学频率传递", "时间频率传递", "频率驾驭", "原子时", "时间尺度",
]
TIMEFREQ_CONTEXT_TERMS_EN = [
    "hydrogen maser", "rubidium atomic clock", "cesium atomic clock", "caesium atomic clock", "cold atom clock",
    "optical atomic clock", "optical clock", "atomic clock", "optical frequency transfer", "time-frequency transfer", "time frequency transfer", "atomic time",
]
